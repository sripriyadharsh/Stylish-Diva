        ...
        <Fragment>
                ...
                {items.map(item=>(
                    ...
                    <div className="row">
                        <div className="col-4 col-lg-3">
                            <img src={item.image} alt={item.name} height="150" width="115"  />
                        </div>
                        ...
                        <div className="col-4 col-lg-2 mt-4 mt-lg-0">
                            <p id="card_item_price" style={{color:'#FF339F'}}>Rs.{item.price}</p>
                        </div>
            ...
            <div className="col-12 col-lg-3 my-4">
                <div id="order_summary">
                    ...
                    <hr />
                    <button id="checkout_btn" onClick={checkoutHandler} style={{backgroundColor:'#FF339F'}} className="btn btn-primary btn-block">Check out</button>
                </div>
            </div>
        </div>
