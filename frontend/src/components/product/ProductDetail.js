        ...
        <Fragment>
            ...
            <Fragment>
                ...
                <div className="row f-flex justify-content-around">
                    ...
                    { user ?
                    <button onClick={handleShow} style={{backgroundColor:'#FF339F'}} id="review_btn" type="button" className="btn btn-primary mt-4" data-toggle="modal" data-target="#ratingModal">
                                Submit Your Review
                    </button> :
